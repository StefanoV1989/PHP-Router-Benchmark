...
final class FinalizationBench extends AdapterBenchCase
{
    /** @return iterable<string, array{router: string, size: int}> */
    public function provideCases(): iterable
    {
        return BenchmarkParameters::combinations(Feature::Finalization);
    }
    ...
    public function benchFinalizeRouteTable(): FinalizationResult
    {
