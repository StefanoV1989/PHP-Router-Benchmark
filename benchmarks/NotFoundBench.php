...
final class NotFoundBench extends AdapterBenchCase
{
    ...
    public function setUp(array $params): void
    {
        ...
        $this->request = $this->adapter->prepareRequest('GET', '/benchmark/definitely-missing');
        $this->adapter->finalize();
    }

    #[Subject, BeforeMethods('setUp'), ParamProviders('provideCases'), Revs(500), Iterations(9), Warmup(2)]
    public function benchWarmRouteMiss(): MatchResult
    {
